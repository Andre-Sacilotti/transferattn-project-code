...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset UCF_HMDB_I3D --source hmdb --target ucf --adv_coeff 0.5 --queue_size 512 --IB_weight 0.001 --batch_size 32 --sampled_frame 53 --use_ib_loss --use_adv_loss --use_MDTA
...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset UCF_HMDB_STAM --source hmdb --target ucf --adv_coeff 0.5 --queue_size 512 --IB_weight 0.001 --batch_size 32 --sampled_frame 53 --use_ib_loss --use_adv_loss --use_MDTA 
