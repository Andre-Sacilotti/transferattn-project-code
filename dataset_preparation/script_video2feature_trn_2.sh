...
# ----------------------------------------------------------------------------------
# variable
data_path=../../datasets/hmdb_ucf/hmdb51/RGB # depend on users
# video_in=""
...
class_file=../TA3N/data/hmdb51_splits/class_list_hmdb_ucf.txt # none | XXX/class_list_DA.txt (depend on users)

CUDA_VISIBLE_DEVICES=0 python -W ignore video2feature_trn.py --data_path $data_path \
